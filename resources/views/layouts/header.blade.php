<form class="form-inline mr-auto" action="#" style="background-color:#102C57">
    <ul class="navbar-nav mr-3" style="background-color:#102C57">
        <li><a href="#" data-toggle="sidebar" class="nav-link nav-link-lg"><i class="fas fa-bars"></i></a></li>
    </ul>
</form>
<ul class="navbar-nav navbar-right" style="background-color:#102C57">

    @if(\Illuminate\Support\Facades\Auth::user())
        <li class="dropdown" style="background-color:#102C57">
            ...
            <div style="background-color:#faf8f7" class="dropdown-menu dropdown-menu-right">
