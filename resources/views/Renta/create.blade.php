@extends('layouts.app')
<!-- Dentro del bloque head en tu layout -->
<link rel="stylesheet" href="{{ asset('css/app.css') }}"> <!-- Cambia 'app.css' si tu archivo tiene otro nombre -->
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open(array('route' => 'departamentos.store','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                                <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::number('precio_renta', null, array('class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <button type="submit" class="btn btn-outline-dark" style="background-color: #ff7464;border-color: #ff7464;color: white; box-shadow: 3px 3px 6px rgba(.5, .5, .5, .5);">Guardar</button>
                                        <a href="/departamentos" class="btn btn-outline-dark" style="background-color: #605c8c;border-color: #605c8c;color: white; box-shadow: 3px 3px 6px rgba(.5, .5, .5, .5);">Cancelar</a>
                                    </div>
                                </div>
                            {!! Form::close() !!}
                        </div>
